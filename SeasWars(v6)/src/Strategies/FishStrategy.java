...
public class FishStrategy extends BaseStrategy {       
        ...
        if(args != null && refPantalla.iniciada && args.length == 2){
            ...
            if(index != -1){
                try {
                    ...
                    if(damageBuff){
                        refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+FishStrategy.STRATEGY_NAME+"/"+"1"+"/"+ Warrior+"/"+power);
                    }else{
                        refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+FishStrategy.STRATEGY_NAME+"/"+"1"+"/"+ Warrior+"/"+0);
                    }
    ...
    public void execute2(String[] args, String Warrior, boolean damageBuff, int power) {
        if(args != null && refPantalla.iniciada && args.length == 2){
            ...
            if(index != -1){
                ...
                try {
                    refPantalla.refCliente.hiloCliente.writer.writeInt(11);
                    refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+FishStrategy.STRATEGY_NAME+"/"+"2"+"/"+ Warrior);
                    refPantalla.refCliente.hiloCliente.writer.writeInt(index);
                } catch (IOException ex) {
        ...
        if(args != null && refPantalla.iniciada && args.length == 2){
            ...
            if(index != -1){
                ...
                try {
                    refPantalla.refCliente.hiloCliente.writer.writeInt(11);
                    if(damageBuff){
                        refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+FishStrategy.STRATEGY_NAME+"/"+"3"+"/"+ Warrior+"/"+power);
                    }else{
                        refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+FishStrategy.STRATEGY_NAME+"/"+"3"+"/"+ Warrior+"/"+0);
                    }
