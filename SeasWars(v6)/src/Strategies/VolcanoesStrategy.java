...
public class VolcanoesStrategy extends BaseStrategy {       
        ...
        if(args != null && refPantalla.iniciada && args.length == 2){
            ...
            if(index != -1){
                try {
                    ...
                    refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+VolcanoesStrategy.STRATEGY_NAME+"/"+"1"+"/"+ Warrior);
            ...
            if(index != -1){
                ...
                if(args.length == 4 && CommandUtil.isInteger(args[2]) && CommandUtil.isInteger(args[3])){
                    try {
                        ...
                        if(damageBuff){
                            refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+VolcanoesStrategy.STRATEGY_NAME+"/"+"2"+"/"+args[2]+"/"+args[3]+"/"+ Warrior+"/"+power);
                        }else{
                            refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+VolcanoesStrategy.STRATEGY_NAME+"/"+"2"+"/"+args[2]+"/"+args[3]+"/"+ Warrior+"/"+0);
                        }
                        refPantalla.refCliente.hiloCliente.writer.writeInt(index);
                    } catch (IOException ex) {
            ...
            if(index != -1){
                ...
                if(args.length == 4 && CommandUtil.isInteger(args[2]) && CommandUtil.isInteger(args[3])){
                    try {
                        ...
                        if(damageBuff){
                            refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+VolcanoesStrategy.STRATEGY_NAME+"/"+"3"+"/"+args[2]+"/"+args[3]+"/"+ Warrior+"/"+power);
                        }else{
                            refPantalla.refCliente.hiloCliente.writer.writeUTF(refPantalla.indexFi+"/"+VolcanoesStrategy.STRATEGY_NAME+"/"+"3"+"/"+args[2]+"/"+args[3]+"/"+ Warrior+"/"+0);
                        }
                        refPantalla.refCliente.hiloCliente.writer.writeInt(index);
                    } catch (IOException ex) {
